...
export default function Home() {
  ...
  return (
    <main className={`relative min-h-screen overflow-x-hidden transition-colors duration-700 ${isUpsideDown ? "bg-transparent" : "bg-[#fdf6e3]"}`}>
      <TransitionCanvas isUpsideDown={isUpsideDown} />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        ...
        <nav className="flex justify-between items-baseline mb-32 border-b border-current pb-4">
          ...
          <button
            onClick={toggleTheme}
            className={`px-4 py-1 border text-xs font-mono tracking-widest transition-all font-terminal ${isUpsideDown
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-40 relative">
          ...
          <h2 className={`text-6xl md:text-9xl font-black mb-8 leading-[0.85] tracking-tighter uppercase transition-all duration-500 ${isUpsideDown
          ...
          <div className={`max-w-xl text-lg md:text-xl leading-relaxed font-medium font-terminal mt-8 border-l-2 pl-4 ${isUpsideDown ? "text-red-300 border-red-500" : "text-gray-800 border-black"
            }`}>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <a
              href="/resume.pdf"
              download
              className={`px-6 py-3 font-terminal text-sm uppercase border transition-all duration-300 flex items-center gap-2 ${isUpsideDown
            ...
            <div className="flex-grow flex flex-col gap-8 w-full relative">
              ...
              {allProjects.map((project) => (
                <div
                  ...
                  className={`relative p-0 transition-all duration-300 group overflow-hidden shadow-sm ${isUpsideDown
                ...
                >
                  {/* Header Strip */}
                  <div className={`p-2 text-[15px] font-mono uppercase flex justify-between border-b font-terminal ${isUpsideDown ? "bg-red-900/20 border-red-900" : "bg-black text-[#fdf6e3] border-black"
                    }`}>
                  ...
                  <div className="p-8">
                    ...
                    <p className={`text-xl mb-6 font-terminal leading-relaxed ${isUpsideDown ? "text-red-300" : "text-gray-700"
                      }`}>
                      {project.desc}
                    </p>
                    ...
                    <div className="flex gap-2 flex-wrap font-mono text-[15px] uppercase opacity-70">
                      {project.tech.map(t => (
                        <span key={t} className={`px-2 py-1 border font-terminal ${isUpsideDown ? "border-red-800 bg-red-900/20 text-red-300" : "border-black/20 text-black"
                          }`}>
                          [ {t} ]
                        </span>
                      ))}
                    ...
                    <div className="flex gap-4 mt-6 pt-4 border-t border-current/10">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className={`px-4 py-2 font-terminal text-sm uppercase border transition-colors duration-300 ${isUpsideDown
